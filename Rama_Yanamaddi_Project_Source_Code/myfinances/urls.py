...
from myfinances import api
from myfinances.rest import views as rest_views
from myfinances.views import accounts as account_views
from myfinances.views import budgets as budget_views
from myfinances.views import categories as category_views
from myfinances.views import charts as chart_views
from myfinances.views import imports as import_views
from myfinances.views import index as general_views
from myfinances.views import recurrences as recurrence_views
from myfinances.views import reports as report_views
from myfinances.views import transactions as transaction_views
...
urlpatterns = [
   ...
   # path('auth/', include('allauth.urls')),
    ...
    path('manifest.json', TemplateView.as_view(template_name='myfinances/manifest.json'),
         name='manifest'),
