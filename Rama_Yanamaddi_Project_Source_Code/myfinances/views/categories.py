...
from myfinances.forms import CategoryAssignFormset
from myfinances.lib import last_day_of_month
from myfinances.models import AccountType, Category, Split


class CategoryIndex(LoginRequiredMixin, generic.ListView):
    template_name = 'myfinances/category_index.html'
    model = Category
...
class CategoryByMonth(LoginRequiredMixin, generic.TemplateView):
    template_name = 'myfinances/category_by_month.html'
...
class InactiveCategoriesView(LoginRequiredMixin, generic.ListView):
    model = Category
    template_name = 'myfinances/inactive_categories.html'
...
def assign_categories(request):
    ...
    return render(request, 'myfinances/category_assign.html',
