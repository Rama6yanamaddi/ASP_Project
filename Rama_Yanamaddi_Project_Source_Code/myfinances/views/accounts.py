...
from myfinances.forms import AccountCreateForm, ForeignAccountForm, ReconcilationForm
from myfinances.models import Account, AccountType, Split, Transaction
...
class AccountIndex(LoginRequiredMixin, generic.TemplateView):
    template_name = 'myfinances/accounts.html'
...
class ForeignAccountIndex(LoginRequiredMixin, generic.ListView):
    template_name = 'myfinances/foreign_accounts.html'
    queryset = Account.objects.foreign()
    paginate_by = 20


class AccountView(LoginRequiredMixin, generic.ListView):
    template_name = 'myfinances/account_detail.html'
...
class ReconcileView(LoginRequiredMixin, generic.edit.CreateView):
    template_name = 'myfinances/reconcile.html'
