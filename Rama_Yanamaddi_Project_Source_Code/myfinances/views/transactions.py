...
from myfinances.forms import DepositForm, TransactionFormSet, TransferForm, WithdrawForm
from myfinances.models import AccountType, Split, Transaction
...
class TransactionIndex(LoginRequiredMixin, generic.ListView):
    template_name = 'myfinances/transaction_overview.html'
...
class SplitCreate(LoginRequiredMixin, generic.edit.CreateView):
    model = Transaction
    template_name = 'myfinances/transaction_split_form.html'
